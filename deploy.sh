...
FILES=".stumpwm.start .stumpwmrc .stumpwm-functions.lisp .profile .bashrc .shrc .shrc-env .shrc-path .shrc-aliases .shrc-prompt .shrc-completion .tmux.conf .ratpoisonrc .vimrc .git-completion.bash .conkerorrc .conkeror .sbclrc .xmonad .Xmodmap quicklisp .ctags .gitignore_global .zshrc Makefile .gitconfig .stalonetrayrc .FBReader .xscreensaver .gimpgimp-layout-1920x1080 .gimpgimp-rules .offlineimaprc .signature .signature2 .offlineimap-helpers.py .xmobarrc .Xresources .urxvt .layouts .nixpkgs .xinit .ghc .zshenv .apvlvrc .nix .ocamlinit .gtkrc-2.0 .spacemacs"
